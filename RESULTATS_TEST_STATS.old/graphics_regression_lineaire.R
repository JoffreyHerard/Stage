...
#lm(Scores~Nombre_de_machines)$residuals
lm(ScoreDOCKER~Nombre_de_machines)$residuals
#lm(ScoreLXC~Nombre_de_machines)$residuals
#lm(ScoreQEMU~Nombre_de_machines)$residuals
#lm(Scores~Nombre_de_machines)$residuals
legend(x="topleft",legend=c("KVM","Docker","LXC","QEMU"),text.col=c("orange","blue","red","purple"),pch=16,col=c("orange","blue","red","purple"))
#PHP BENCH
